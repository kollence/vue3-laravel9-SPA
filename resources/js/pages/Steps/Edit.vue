...
const {step, getStep, updateStep, validErrors, isLoading} = useSteps()
...
//!!! composables step ref can be used here
watch(step,(curr, prev) =>{
        if(curr.image !== null){
            imageUrl.value = '/step_images/'+ curr.image
        }
...
<template>
    <div class="overflow-hidden overflow-x-auto p-6 bg-white border-gray-200">
        ...
        <form @submit.prevent="handleSubmit(step)">
            ...
            <router-link class="px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg float-right" 
             :to="{name: 'steps'}">
             <span >Back</span>
             </router-link>
        </form>
